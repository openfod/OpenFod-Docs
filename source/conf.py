...
_UI_TEXT = {
    "zh": {
        ...
        "ai_search_retention_notice": "Ask AI 只会检索本站已经发布的文档片段。生产环境的大模型参数由 OpenFod-Website 的 GitHub Pages 环境密钥注入，不会写进本文档仓库。",
    ...
    "en": {
        ...
        "ai_search_retention_notice": "Ask AI only searches published documentation. Production model settings come from OpenFod-Website GitHub Pages environment secrets and are not stored in this docs repository.",
